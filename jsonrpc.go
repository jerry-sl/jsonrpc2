...
type RPCClient interface {
	...
	CallRaw(request *RPCRequest) (string, error)
...
func (client *rpcClient) Call(method string, params ...interface{}) (string, error) {
...
func (client *rpcClient) CallRaw(request *RPCRequest) (string, error) {
...
func (client *rpcClient) doCall(RPCRequest *RPCRequest) (string, error) {
